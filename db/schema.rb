...
ActiveRecord::Schema.define(version: 2020_07_30_155200) do
  ...
  create_table "attributions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_attributions_on_doctor_id"
    t.index ["specialty_id"], name: "index_attributions_on_specialty_id"
  end
